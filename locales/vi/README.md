...
<br>
<div align="center">
  <h2>Tham Gia Cộng Đồng Weavy</h2>
...
<div align="center">
<h1>Weavy (trước đây là Roo Cline)</h1>
...
**Weavy** là một **tác nhân lập trình tự trị** được hỗ trợ bởi AI sống trong trình soạn thảo của bạn. Nó có thể:
...
Cho dù bạn đang tìm kiếm một đối tác lập trình linh hoạt, một kiến trúc sư hệ thống, hay các vai trò chuyên biệt như kỹ sư QA hoặc quản lý sản phẩm, Weavy có thể giúp bạn xây dựng phần mềm hiệu quả hơn.

Kiểm tra [CHANGELOG](../CHANGELOG.md) để biết thông tin chi tiết về các cập nhật và sửa lỗi.

---

## 🎉 Đã Phát Hành Weavy 3.11

Weavy 3.11 mang đến những cải tiến hiệu suất đáng kể và các tính năng mới!
...
1. [Cài đặt Weavy](https://docs.roocode.com/getting-started/installing)
...
Weavy thích ứng với nhu cầu của bạn với các [chế độ](https://docs.roocode.com/basic-usage/using-modes) chuyên biệt:
...
Weavy đi kèm với các [công cụ](https://docs.roocode.com/basic-usage/how-tools-work) mạnh mẽ có thể:
...
MCP mở rộng khả năng của Weavy bằng cách cho phép bạn thêm vô số công cụ tùy chỉnh. Tích hợp với API bên ngoài, kết nối với cơ sở dữ liệu, hoặc tạo các công cụ phát triển chuyên biệt - MCP cung cấp khung để mở rộng chức năng của Weavy để đáp ứng nhu cầu cụ thể của bạn.

### Tùy Chỉnh

Làm cho Weavy hoạt động theo cách của bạn với:
...
4. **Gỡ lỗi**:
   Nhấn `F5` (hoặc **Run** → **Start Debugging**) trong VSCode để mở phiên mới với Weavy được tải.
...
Cảm ơn tất cả những người đóng góp đã giúp cải thiện Weavy!
...
**Hãy tận hưởng Weavy!** Cho dù bạn giữ nó trên dây ngắn hay để nó tự do hoạt động, chúng tôi rất mong được thấy những gì bạn xây dựng. Nếu bạn có câu hỏi hoặc ý tưởng về tính năng, hãy ghé qua [cộng đồng Reddit](https://www.reddit.com/r/RooCode/) hoặc [Discord](https://discord.gg/roocode) của chúng tôi. Chúc lập trình vui vẻ!
