...
<br>
<div align="center">
  <h2>Uniu-vos a la Comunitat Weavy</h2>
...
**Weavy** és un **agent de programació autònom** impulsat per IA que viu en el vostre editor. Pot:
...
Tant si busqueu un soci de programació flexible, un arquitecte de sistemes o rols especialitzats com un enginyer de control de qualitat o un gestor de producte, Weavy us pot ajudar a construir programari de manera més eficient.
...
Weavy 3.11 aporta millores significatives de rendiment i noves funcionalitats!
...
1. [Instal·leu Weavy](https://docs.roocode.com/getting-started/installing)
...
Weavy s'adapta a les vostres necessitats amb [modes](https://docs.roocode.com/basic-usage/using-modes) especialitzats:
...
Weavy ve amb potents [eines](https://docs.roocode.com/basic-usage/how-tools-work) que poden:
...
MCP amplia les capacitats de Weavy permetent-vos afegir eines personalitzades il·limitades. Integreu amb APIs externes, connecteu-vos a bases de dades o creeu eines de desenvolupament especialitzades - MCP proporciona el marc per expandir la funcionalitat de Weavy per satisfer les vostres necessitats específiques.

### Personalització

Feu que Weavy funcioni a la vostra manera amb:
...
Gràcies a tots els nostres col·laboradors que han ajudat a millorar Weavy!
