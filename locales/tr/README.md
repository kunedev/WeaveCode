...
<br>
<div align="center">
  <h2>Weavy Topluluğuna Katılın</h2>
...
<div align="center">
<h1>Weavy (önceki adıyla Roo Cline)</h1>
...
**Weavy**, editörünüzde çalışan yapay zeka destekli **otonom kodlama aracı**dır. Yapabilecekleri:
...
İster esnek bir kodlama ortağı, ister bir sistem mimarı, isterse QA mühendisi veya ürün yöneticisi gibi uzmanlaşmış roller arıyor olun, Weavy yazılım geliştirme sürecinizi daha verimli hale getirmenize yardımcı olabilir.

Detaylı güncellemeler ve düzeltmeler için [CHANGELOG](../CHANGELOG.md) dosyasını kontrol edin.

---

## 🎉 Weavy 3.11 Yayınlandı

Weavy 3.11 önemli performans iyileştirmeleri ve yeni özellikler getiriyor!
...
1. [Weavy'u Yükleyin](https://docs.roocode.com/getting-started/installing)
...
Weavy, özelleştirilmiş [modlar](https://docs.roocode.com/basic-usage/using-modes) ile ihtiyaçlarınıza uyum sağlar:
...
Weavy, şunları yapabilen güçlü [araçlar](https://docs.roocode.com/basic-usage/how-tools-work) ile gelir:
...
MCP, sınırsız özel araç eklemenize izin vererek Weavy'un yeteneklerini genişletir. Harici API'lerle entegre olun, veritabanlarına bağlanın veya özel geliştirme araçları oluşturun - MCP, Weavy'un işlevselliğini özel ihtiyaçlarınızı karşılamak üzere genişletmek için çerçeve sağlar.

### Özelleştirme

Weavy'u kendi tarzınıza göre çalıştırın:
...
4. **Hata ayıklama**:
   VSCode'da `F5` tuşuna basın (veya **Run** → **Start Debugging**) Weavy yüklenmiş yeni bir oturum açmak için.
...
Weavy'u daha iyi hale getirmeye yardımcı olan tüm katkıda bulunanlara teşekkür ederiz!
