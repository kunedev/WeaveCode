...
<br>
<div align="center">
  <h2>Únete a la comunidad de Weavy</h2>
...
**Weavy** es un **agente de programación autónomo** impulsado por IA que vive en tu editor. Puede:
...
Ya sea que busques un socio de programación flexible, un arquitecto de sistemas o roles especializados como ingeniero de control de calidad o gestor de productos, Weavy puede ayudarte a construir software de manera más eficiente.
...
¡Weavy 3.11 trae mejoras significativas de rendimiento y nuevas funcionalidades!
...
1. [Instalar Weavy](https://docs.roocode.com/getting-started/installing)
...
Weavy se adapta a tus necesidades con [modos](https://docs.roocode.com/basic-usage/using-modes) especializados:
...
Weavy viene con potentes [herramientas](https://docs.roocode.com/basic-usage/how-tools-work) que pueden:
...
MCP amplía las capacidades de Weavy al permitirte añadir herramientas personalizadas ilimitadas. Integra con APIs externas, conéctate a bases de datos o crea herramientas de desarrollo especializadas - MCP proporciona el marco para expandir la funcionalidad de Weavy para satisfacer tus necesidades específicas.

### Personalización

Haz que Weavy funcione a tu manera con:
...
¡Gracias a todos nuestros colaboradores que han ayudado a mejorar Weavy!
