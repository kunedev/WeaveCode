...
**Weavy** 是一個存在於您編輯器中的 AI 驅動的**自主編碼代理**。它可以：
...
無論您是尋找一個靈活的編碼夥伴、系統架構師，還是專業角色如 QA 工程師或產品經理，Weavy 都能幫助您更高效地構建軟件。
...
1. [安裝 Weavy](https://docs.roocode.com/getting-started/installing)
...
Weavy 通過專業化的[模式](https://docs.roocode.com/basic-usage/using-modes)適應您的需求：
...
Weavy 配備強大的[工具](https://docs.roocode.com/basic-usage/how-tools-work)，可以：
...
MCP 擴展了 Weavy 的能力，允許您添加無限的自定義工具。與外部 API 整合，連接到數據庫，或創建專業開發工具 - MCP 提供了擴展 Weavy 功能以滿足您特定需求的框架。
...
**請注意**，Roo Veterinary, Inc **不**對與 Weavy 相關的任何代碼、模型或其他工具，任何相關的第三方工具，或任何產生的輸出做出任何陳述或保證。您承擔使用此類工具或輸出的**所有風險**；這些工具按**"原樣"**和**"可用性"**提供。這些風險可能包括但不限於智慧財產侵權、網絡漏洞或攻擊、偏見、不準確、錯誤、缺陷、病毒、停機時間、財產損失或損壞和/或人身傷害。您對這些工具或輸出的使用（包括但不限於其合法性、適當性和結果）完全負責。
...
**享受 Weavy！** 無論您是將它拴在短繩上還是讓它自主漫遊，我們迫不及待地想看看您會構建什麼。如果您有問題或功能想法，請訪問我們的 [Reddit 社區](https://www.reddit.com/r/RooCode/)或 [Discord](https://discord.gg/roocode)。祝您編碼愉快！
